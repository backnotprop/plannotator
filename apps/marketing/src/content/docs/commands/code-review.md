...
The base for **Line** is named after the bookmark on the commit the line forked
from, preferring its remote bookmark. Bookmarks generated by `jj git push
