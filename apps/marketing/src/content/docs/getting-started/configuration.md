...
| `PLANNOTATOR_AI` | enabled | Set to `disabled` to skip AI providers and hide Ask AI, Review Agents, and Guided Review. External agents can still open reviews and submit annotations. |
