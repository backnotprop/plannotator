...
| `PLANNOTATOR_AI` | enabled | Set to `disabled` to disable Ask AI, Review Agents, and Guided Review, including their server endpoints. External agents can still open reviews and submit annotations; the annotate agent terminal is separate. |
