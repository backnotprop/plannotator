...
<iframe width="100%" style="aspect-ratio: 16/9;" src="https://www.youtube.com/embed/PLACEHOLDER" title="Plan Diff Demo" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>

## The problem

You're reviewing a plan in Plannotator. Something's off — maybe the auth approach is wrong, or a step is missing. You deny the plan with annotations. The agent revises and resubmits.

Now you're staring at the updated plan, trying to figure out what actually changed. Did the agent address your feedback? Did it restructure something else? With a long plan, you're scanning the whole thing again line by line. This was one of the most [requested features](https://github.com/backnotprop/plannotator/issues/138) from the community — users dealing with large plans wanted a way to skip the guesswork and go straight to what's different.
...
- **Rendered diff** — the plan renders as usual, but with color-coded left borders. Green for added sections, red with strikethrough for removed content, and yellow for lines that were modified. You can scan the plan visually and immediately spot where the changes landed.
