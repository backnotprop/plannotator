...
trackerStatus:
  ...
  status: to-do
  priority: high
  tags: ["plannotator", "e2e", "testing", "playwright", "daemon"]
  created: 2026-05-02T04:03:09.140Z
  updated: 2026-05-04T06:30:00.000Z
---
...
- `01-binary.spec.ts` — binary surface (fast gate), help/version, aliases, deleted flags absence
...
- `99-deletions-and-doc.spec.ts` — deleted surfaces, AGENTS.md staleness (mark as known failing/docs gate), stale scripts
