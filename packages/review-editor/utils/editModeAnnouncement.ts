 ...
 * chain (guide intro, then look-and-feel, then this) and must never stack with
 * either of them. Waiting for isLoading to clear matters: the earlier dialogs
 * latch during the initial diff load, so rendering earlier could flash this
 * dialog under a chain that is about to open.
 */
