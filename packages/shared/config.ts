...
export interface PlannotatorConfig {
   ...
   * PLANNOTATOR_SKIP_ANTIGRAVITY_INSTALL /
   ...
   * --skip-antigravity / --skip-kiro / --skip-opencode flags. OpenCode has no
   * detection leg, so its entry is a plain do-not-write switch. Default: all off.
   */
  skipInstall?: {
    codex?: boolean;
    gemini?: boolean;
