...
Delegated [[S-6]] after accepting [[TDD-S-6]] proof commit `f7f39ea` and checkpointing `main` at `846f233`. Verification target for this implementation is `bun test tests/nim-18.cli-contract-proof.test.ts`.
