...
Delegated [[S-6]] after accepting [[NIM-18]] proof commit `f7f39ea` and checkpointing `main` at `846f233`. Verification target for this implementation is `bun test tests/nim-18.cli-contract-proof.test.ts`.
