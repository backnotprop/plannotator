...
Delegated [[S-5]] after accepting [[TDD-S-5]] proof commit `edd9ac3` and checkpointing `main` at `f0fad5b`. Verification target for this implementation is `bun test tests/nim-17.submit-wait-proof.test.ts`.
