...
Process rule:
- This proof task must be authored separately from implementation, and [[S-7]] writers may not weaken or rewrite the tests after handoff.
...
This is the expected missing implementation surface for [[S-7]].
